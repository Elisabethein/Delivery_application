<template>
  <main>
    ...
    <div class = vehicle-container>
      ...
      <h2 class="choose-vehicle" :class="{ 'visible-text': vehicleSelected }">Delivery fee for {{ chosenVehicle }} in {{ chosenCity }} is:</h2>      
...
export default {
  ...
  methods: {
    ...
    getDeliveryFee(city, vehicle){
        ...
        fetch(`http://localhost:8080/api/calculateRbf/${city}/${vehicle}`)
